...
import { contactSchema, initialContactValue } from "@/lib/schemas.js";
...
const AddContact = () => {
  ...
  const formik = useFormik({
    initialValues: initialContactValue,
    validate,
    validateOnBlur: true,
    validateOnChange: false,
    onSubmit: (values, { setSubmitting, resetForm }) => {
      const result = addContact(values);

      if (result.success) {
        resetForm();
        navigate("/", {
          state: { message: "Kontak Berhasil Ditambahkan" },
        });
    ...
    <div className="py-6 pb-20">
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="space-y-3 mt-6">
          ...
          >
            <Save className="mr-2" />
            {formik.isSubmitting ? "Menyimpan..." : "Simpan Kontak"}
          </Button>
        </div>
      </form>
    </div>
